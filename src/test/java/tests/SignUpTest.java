...
public class SignUpTest extends  TestBase{
    ...
    public void urlCorrectionCheck() {
        ...
        @Test()
            ...
            signUpPage.signUpPassword.sendKeys(faker.internet().password());
            signUpPage.sinUpButton.click();
    ...
    public void negativeSignInTestWithWrongCredentials(){
            ...
            signUpPage.signUpPassword.sendKeys(faker.business().creditCardNumber());
            signUpPage.sinUpButton.click();
